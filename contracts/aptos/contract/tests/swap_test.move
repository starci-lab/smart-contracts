...
module cifarm::swap_test {
    ...
    use cifarm::swap::{Self, LPToken, initialize};
    use cifarm::router;
    use cifarm::math;
    use aptos_std::math64::pow;
    use cifarm::swap_utils;

    const MAX_U64: u64 = 18446744073709551615;
    const MINIMUM_LIQUIDITY: u128 = 1000;

    public fun setup_test_with_genesis(dev: &signer, admin: &signer, treasury: &signer, resource_account: &signer, aptos_framework: &signer) {
        genesis::setup();
        setup_test(dev, admin, treasury, resource_account, aptos_framework);
    }

    public fun setup_test(dev: &signer, admin: &signer, treasury: &signer, resource_account: &signer, aptos_framework: &signer) {
        ...
        resource_account::create_resource_account(dev, b"cifarm", x"");
    ...
    fun test_add_liquidity(
        ...
        setup_test_with_genesis(dev, admin, treasury, resource_account, aptos_framework);
    ...
    #[test(dev = @dev, admin = @default_admin, resource_account = @cifarm, treasury = @0x23456, bob = @0x12345, alice = @0x12346, aptos_framework = @0x1)]
    #[expected_failure(abort_code = 3, location = cifarm::router)]
    ...
    #[test(dev = @dev, admin = @default_admin, resource_account = @cifarm, treasury = @0x23456, bob = @0x12345, alice = @0x12346, aptos_framework = @0x1)]
    #[expected_failure(abort_code = 2, location = cifarm::router)]
    ...
    #[test(dev = @dev, admin = @default_admin, resource_account = @cifarm, treasury = @0x23456, user1 = @0x12341, user2 = @0x12342, user3 = @0x12343, user4 = @0x12344, aptos_framework = @0x1)]
    ...
    #[test(dev = @dev, admin = @default_admin, resource_account = @cifarm, treasury = @0x23456, bob = @0x12341, alice = @0x12342, aptos_framework = @0x1)]
    #[expected_failure(abort_code = 10, location = cifarm::swap)]
    ...
    #[test(dev = @dev, admin = @default_admin, resource_account = @cifarm, treasury = @0x23456, bob = @0x12345, alice = @0x12346, aptos_framework = @0x1)]
    #[expected_failure(abort_code = 65540, location = 0x1::fungible_asset)]
    ...
    #[test(dev = @dev, admin = @default_admin, resource_account = @cifarm, treasury = @0x23456, bob = @0x12345, alice = @0x12346, aptos_framework = @0x1)]
    #[expected_failure(abort_code = 0, location = cifarm::router)]
    ...
    #[test(dev = @dev, admin = @default_admin, resource_account = @cifarm, treasury = @0x23456, bob = @0x12345, alice = @0x12346, aptos_framework = @0x1)]
    #[expected_failure(abort_code = 1, location = cifarm::router)]
    ...
    #[test(dev = @dev, admin = @default_admin, resource_account = @cifarm, treasury = @0x23456, user1 = @0x12341, user2 = @0x12342, user3 = @0x12343, user4 = @0x12344, alice = @0x12345, aptos_framework = @0x1)]
    #[expected_failure(abort_code = 21, location = cifarm::swap)]
