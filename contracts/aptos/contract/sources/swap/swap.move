...
module cifarm::swap {
    ...
    */
    ...
    public(friend) fun create_pair<X, Y>(
        ...
        let lp_name: string::String = string::utf8(b"Cifarm-");
        ...
        if (string::length(&lp_name) > MAX_COIN_NAME_LENGTH) {
            lp_name = string::utf8(b"Cifarm LPs");
        };
